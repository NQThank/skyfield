...
import { FormLayoutItem, GeneralInfoForm } from '@/core/types';
...
const schemaLocal: yup.ObjectSchema<GeneralInfoForm> = yup.object({
  ...
  type: yup.mixed<TemplateTypeEnum>().oneOf(Object.values(TemplateTypeEnum)).required(),
  priority: yup.mixed<PriorityEnum>().oneOf(Object.values(PriorityEnum)).required(),
  sector_required: yup.boolean().default(false)
});

export type FormRef = FormInstance<GeneralInfoForm>;

const TemplateGeneralInfoJob: React.FC<TemplateGeneralInfoProps> = forwardRef<FormRef, TemplateGeneralInfoProps>(
        ...
        items={[
          {
            ...
            children: (
              ...
              >
                ...
                <Form.Item label="Scope" name={'scppe'}>
...
export default memo(TemplateGeneralInfoJob);
